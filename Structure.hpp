...
namespace BinaryTree
{
    ...
    template <typename T>
    BinaryTreeNode<T>* create_tree_floororder(const std::list<T>& values, BinaryTreeNode<T>* node, const T& none = NULL)
    {
...
public:
    ...
    void load_data(const std::list<T>& values)
    {
        ...
        std::list<T>::const_iterator it = values.cbegin(), end = values.cend();
